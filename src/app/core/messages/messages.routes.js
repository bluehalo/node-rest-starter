...
router.route('/admin/message')
	.post(user.hasAdminAccess, messages.create);

// Search messages
router.route('/messages')
	.post(user.hasAccess, messages.search);

router.route('/messages/recent')
	.post(user.hasAccess, messages.getRecentMessages);

// Dismiss a message
router.route('/messages/dismiss')
	.post(user.hasAccess, messages.dismissMessage);
