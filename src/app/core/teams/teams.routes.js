...
router.route('/team/:teamId')
	.get(   user.hasAccess, user.hasAny(user.requiresAdminRole, teams.requiresMember), teams.read)
	.post(  user.hasAccess, user.hasAny(user.requiresAdminRole, teams.requiresAdmin), teams.update)
	.delete(user.hasAccess, user.hasAny(user.requiresAdminRole, teams.requiresAdmin), teams.delete);

router.route('/team/:teamId/request')
	.post(user.hasAccess, teams.requestAccess);

router.route('/team-request')
	.post(user.hasAccess, teams.requestNewTeam);
...
router.route('/team/:teamId/member/:memberId')
	.post(  user.hasAccess, user.hasAny(user.requiresAdminRole, teams.requiresAdmin), teams.addMember)
	.delete(user.hasAccess, user.hasAny(user.requiresAdminRole, teams.requiresAdmin), teams.removeMember);

router.route('/team/:teamId/member/:memberId/role')
	.post(  user.hasAccess, user.hasAny(user.requiresAdminRole, teams.requiresAdmin), teams.updateMemberRole);
